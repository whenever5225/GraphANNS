...
static constexpr unsigned ANNOY_MAX_VEC_SIZE = 10000;    // total data size
...
static constexpr int ANNOY_QUERY_RANDOM_SEED = 1;    // query random seed, 0 is for real random
