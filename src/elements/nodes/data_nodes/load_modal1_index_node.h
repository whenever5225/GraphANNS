...
#ifndef GRAPHANNS_LOAD_MODAL1_INDEX_NODE_H
#define GRAPHANNS_LOAD_MODAL1_INDEX_NODE_H
...
public:
    CStatus init() override {
        ...
        while (!f_in.eof()) {
            ...
            m_param->graph_m1_.push_back(tmp);
        }
        f_in.close();
        return CStatus();
    }
...
#endif //GRAPHANNS_LOAD_MODAL1_INDEX_NODE_H
